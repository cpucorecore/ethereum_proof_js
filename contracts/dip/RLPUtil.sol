...
library RLPUtil {
    ...
    // proof arrary RLP encoded by ethereum RLP library: 
    uint constant ExtrasArrayLength = 2;
    function DecodeProof(bytes memory RLPProof) public pure returns (bytes[] memory empty) {
        ...
        bytes[] memory proof = new bytes[](items.length - ExtrasArrayLength);
        for(uint i=ExtrasArrayLength;i<items.length;i++) {
            proof[i-ExtrasArrayLength] = items[i].toBytes();
        }
